# **[Specification]** AS-11 X7 (MXF Program Contribution - SD)

This repository contains the full details of this [AMWA Specification](http://amwa.tv/projects/AS-11-X7/). For the latest version of this repository please refer to [its GitHub project](https://github.com/AMWA-TV/AS-11_X7/).

## Getting Started

The principal rendering / view of the Specification is a [web page, `AMWA_AS_11_X7.html`](AMWA_AS_11_X7.html), that contains contextual links to other files in this repository.
